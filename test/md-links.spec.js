...
describe('validatePath',()=>{
 ...
 describe('validatePath',()=>{
  it('show resolve path', () =>{
    expect(typeof validatePath('C:\\Users\\Madelen\\LIM017-md-lin')).toBe('boolean');
  })
 });
...
describe('getFileMd',()=>{
  it('show if it is a directory or a file', () =>{
   expect(getFileMd('./documents')).toEqual([ 'documents\\file1.md', 'documents\\file2.md', 'documents\\file3.md' ]);
 })
 });
